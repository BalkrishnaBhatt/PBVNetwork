...
export const getServiceLineList = (navigation, area_practice) => {
  let url = 'pbv/v1/service_line?area_practice=' + area_practice;
  const config = {
    headers: {
